...
public class FenetreAjoutCourrier extends Stage {
	...
	public FenetreAjoutCourrier(){
		this.setTitle("Ajouter un courrier");
	...
	public void init(){
		this.listeTypeCourrier.getSelectionModel().clearSelection();
	...
	private void gererBoutons(ActionEvent e) {
		if (e.getSource()==bnOK) {
			...
			Principale.ajouterCourrier(new Courrier(volume, prioritaire, type, new Destinataire(prenom, nom, nomRue)));
			this.close();
		}
